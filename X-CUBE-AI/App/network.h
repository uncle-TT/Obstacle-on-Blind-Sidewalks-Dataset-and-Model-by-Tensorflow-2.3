...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mcu_uint8_quant_model"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 224, 224, 3, 1, NULL), \
}
...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_S8, 1, 1, 13, 1, NULL), \
}
